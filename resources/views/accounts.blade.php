                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="payment-amount">
                                                    ...
                                                    <span>${{ $totalBalance->earned ?? '00' }}</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6">
                                                <div class="payment-amount">
                                                    <h6><i class="fa-solid fa-circle-question text-pink"></i>Requested</h6>
                                                    <span>${{ $totalBalance->requested ?? '00' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <table class="table table-hover table-center mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <a href="#"><span
                                                                        class="text-blue">#AC-1234</span></a>
                                                            </td>
                                                            <td>24 Mar 2024</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="#"><span
                                                                        class="text-blue">#AC-1235</span></a>
                                                            </td>
                                                            <td>28 Mar 2024</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="#"><span
                                                                        class="text-blue">#AC-1236</span></a>
                                                            </td>
                                                            <td>02 Apr 2024</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="#"><span
                                                                        class="text-blue">#AC-1237</span></a>
                                                            </td>
                                                            <td>10 Apr 2024</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="#"><span
                                                                        class="text-blue">#AC-1238</span></a>
                                                            </td>
                                                            <td>16 Apr 2024</td>
                                                ...
                                                <table class="table table-hover table-center mb-0">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <a href="#" class="account-action me-2"><i
                                                                            class="fa-solid fa-link"></i></a>
                                                                    <a href="#"
                                                                        class="account-action text-success me-2"><i
                                                                            class="fa-solid fa-check"></i></a>
                                                                    <a href="#"
                                                                        class="account-action text-danger me-2"><i
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="#"><span
                                                                        class="text-blue">#AC-1239</span></a>
                                                            </td>
                                                            <td>
                                                                <div class="table-avtatar">
                                                                    <a href="{{ url('patient-profile') }}"><img
