            ...
            <div class="invoice-container">
                <div class="row">
                    <div class="col-sm-6 m-b-20">
                        <img alt="Logo" class="inv-logo img-fluid" src="{{ URL::asset('/assets_admin//img/logo.png')}}">
                    </div>
                    <div class="col-sm-6 m-b-20">
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-7 col-xl-8 m-b-20">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li>United States</li>
                            <li>8286329170</li>
                            <li><a href="javascript:;"><span class="__cf_email__"
                                        data-cfemail="84e7ece5f6e8e1eae1f6e1e1e0c4e1fce5e9f4e8e1aae7ebe9">[email&#160;protected]</span></a>
                            </li>
                        </ul>
                    </div>
