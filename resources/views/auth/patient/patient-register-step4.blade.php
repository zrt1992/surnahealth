                    ...
                    <div class="login-right">
                        <div class="inner-right-login">
                            <div class="login-header">
                                ...
                                <form id="personal_details" action="{{ route('user-registration.store.step4') }}"
                                    ...
                                    <div class="step-process-col mt-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="bank_name" class="form-control datetimepicker"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="branch_name" class="form-control datetimepicker"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="account_name" class="form-control datetimepicker"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="account_number" class="form-control datetimepicker"
                                        ...
                                        <div class="remember-me-col d-flex justify-content-between">
                                            ...
                                            <label class="custom_check">Credit card
                                                <input type="checkbox" class="" id="is_registered" name="credit_card"
                                                    value="1">
                                        ...
                                        <div class="remember-me-col d-flex justify-content-between">
                                            ...
                                            <label class="custom_check">Paypal
                                                <input type="checkbox" class="" id="is_registered" name="paypal"
                                                    value="1">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="remember-me-col d-flex justify-content-between">
                                            ...
                                            <label class="custom_check">Stripe
                                                <input type="checkbox" class="" id="is_registered" name="stripe"
                                                    value="1" checked>
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="remember-me-col d-flex justify-content-between">
                                            ...
                                            <label class="custom_check">Mobile money
                                                <input type="checkbox" class="" id="is_registered" name="mobile_money"
                                                    value="1">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <input class="btn btn-primary w-100 btn-lg login-btn" type="submit"
                                                value="Register">
                                        </div>
