                                    ...
                                    <div class="tab-content pt-0">
                                                ...
                                                <div class="slot-body">
                                                    <ul class="time-slots">
                                                        @foreach ($data as $slots)
                                                            @if ($slots->availability_day == 'Monday')
                                                                <li><i
                                            ...
                                            <div class="slot-box">
                                                <div class="slot-header">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="#" class="add-slot" data-bs-toggle="modal"
                                                                data-bs-target="#add_slot" data-day="Tuesday">Add Slots</a>
                                                        </li>
                                                        <li>
                                                            <a href="#" class="del-slot" data-bs-toggle="modal"
                                                                data-bs-target="#delete_slot">Delete All</a>
                                                ...
                                                <div class="slot-body">
                                                    <ul class="time-slots">
                                                        @forelse ($data as $slots)
                                                            @if ($slots->availability_day == 'Tuesday')
                                                                <li><i
                                                                        class="fa-regular fa-clock"></i>{{ $slots->start_time }}
                                                                </li>
                                                            @endif
                                        ...
                                        <div class="tab-pane fade" id="wednesday">
                                            <div class="slot-box">
                                                ...
                                                <div class="slot-body">
                                                    @forelse ($data as $slots)
                                                        @if ($slots->availability_day == 'Wednesday')
                                                            <li><i class="fa-regular fa-clock"></i>{{ $slots->start_time }}
                                                            </li>
                                                        @endif
                                                    @empty
                                                        <p>No Slots Available</p>
                                        ...
                                        <div class="tab-pane fade" id="thursday">
                                            <div class="slot-box">
                                                ...
                                                <div class="slot-body">
                                                    @forelse ($data as $slots)
                                                        @if ($slots->availability_day == 'Thursday')
                                                            <li><i class="fa-regular fa-clock"></i>{{ $slots->start_time }}
                                                            </li>
                                                        @endif
                                                    @empty
                                        ...
                                        <div class="tab-pane fade" id="friday">
                                            <div class="slot-box">
                                                ...
                                                <div class="slot-body">
                                                    @forelse ($data as $slots)
                                                        @if ($slots->availability_day == 'Friday')
                                                            <li><i class="fa-regular fa-clock"></i>{{ $slots->start_time }}
                                                            </li>
                                                        @endif
                                                    @empty
                                        ...
                                        <div class="tab-pane fade" id="saturday">
                                            <div class="slot-box">
                                                ...
                                                <div class="slot-body">
                                                    @forelse ($data as $slots)
                                                        @if ($slots->availability_day == 'Saturday')
                                                            <li><i class="fa-regular fa-clock"></i>{{ $slots->start_time }}
                                                            </li>
                                                        @endif
                                                    @empty
                                        ...
                                        <div class="tab-pane fade" id="sunday">
                                            <div class="slot-box">
                                                ...
                                                <div class="slot-body">
                                                    @forelse ($data as $slots)
                                                        @if ($slots->availability_day == 'Sunday')
                                                            <li><i class="fa-regular fa-clock"></i>{{ $slots->start_time }}
                                                            </li>
                                                        @endif
                                                    @empty
