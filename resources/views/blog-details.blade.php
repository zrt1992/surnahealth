							...
							<div class="blog-view">
								<div class="blog blog-single-post">
									<div class="blog-image">
										<a href="javascript:void(0);"><img alt="blog-image" src="{{URL::asset('/assets/img/blog/blog-01.jpg')}}" class="img-fluid"></a>
									</div>
									<h3 class="blog-title">Surna health – Making your clinic painless visit?</h3>
									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<a href="{{url('doctor-profile')}}"><img class="img-fluid rounded-circle" alt="Darren Elder" src="{{URL::asset('/assets/img/doctors/doctor-thumb-02.jpg')}}"></a>
											</div>
										</div>
										<div class="author-details">
											<a href="{{url('doctor-profile')}}" class="blog-author-name">Dr. Darren Elder</a>
								...
								<div class="card blog-comments clearfix">
									...
									<ul class="comments-list">
										<li>
											<div class="comment">
												<div class="comment-author">
													<img class="avatar" alt="Michelle Fairfax" src="{{URL::asset('/assets/img/patients/patient4.jpg')}}">
												</div>
											...
											<ul class="comments-list reply">
												<li>
													<div class="comment">
														<div class="comment-author">
															<img class="avatar" alt="Gina Moore" src="{{URL::asset('/assets/img/patients/patient5.jpg')}}">
														</div>
														<div class="comment-block">
															<span class="comment-by">
												...
												<li>
													<div class="comment">
														<div class="comment-author">
															<img class="avatar" alt="Carl Kelly" src="{{URL::asset('/assets/img/patients/patient3.jpg')}}">
														</div>
														<div class="comment-block">
															<span class="comment-by">
										...
										<li>
											<div class="comment">
												<div class="comment-author">
													<img class="avatar" alt="Elsie Gilley" src="{{URL::asset('/assets/img/patients/patient6.jpg')}}">
												</div>
												<div class="comment-block">
													<span class="comment-by">
										...
										<li>
											<div class="comment">
												<div class="comment-author">
													<img class="avatar" alt="Joan Gardner" src="{{URL::asset('/assets/img/patients/patient7.jpg')}}">
												</div>
												<div class="comment-block">
													<span class="comment-by">
								...
								<div class="card-body">
									<ul class="latest-posts">
										<li>
											<div class="post-thumb">
												<a href="{{url('blog-details')}}">
													<img class="img-fluid" src="{{URL::asset('/assets/img/blog/blog-thumb-01.jpg')}}" alt="blog-image">
												</a>
											</div>
											<div class="post-info">
												<h4>
													<a href="{{url('blog-details')}}">Surna health – Making your clinic painless visit?</a>
												</h4>
												<p>4 Dec 2023</p>
											</div>
										</li>
										<li>
											<div class="post-thumb">
												<a href="{{url('blog-details')}}">
													<img class="img-fluid" src="{{URL::asset('/assets/img/blog/blog-thumb-02.jpg')}}" alt="blog-image">
												</a>
											</div>
											<div class="post-info">
												<h4>
										...
										<li>
											<div class="post-thumb">
												<a href="{{url('blog-details')}}">
													<img class="img-fluid" src="{{URL::asset('/assets/img/blog/blog-thumb-03.jpg')}}" alt="blog-image">
												</a>
											</div>
											<div class="post-info">
												<h4>
										...
										<li>
											<div class="post-thumb">
												<a href="{{url('blog-details')}}">
													<img class="img-fluid" src="{{URL::asset('/assets/img/blog/blog-thumb-04.jpg')}}" alt="blog-image">
												</a>
											</div>
											<div class="post-info">
												<h4>
										...
										<li>
											<div class="post-thumb">
												<a href="{{url('blog-details')}}">
													<img class="img-fluid" src="{{URL::asset('/assets/img/blog/blog-thumb-05.jpg')}}" alt="blog-image">
												</a>
											</div>
											<div class="post-info">
												<h4>
							...
							<div class="card tags-widget">
								...
								<div class="card-body">
									<ul class="tags">
										...
										<li><a href="#" class="tag">Surna health</a></li>
									</ul>
								</div>
							</div>
							<!-- /Tags -->
