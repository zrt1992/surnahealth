                        ...
                        <ul class="header-list-btns">
                            <li>
                                <div class="input-block dash-search-input">
                                    <form method="GET" action="{{ route('doctor-appointments-grid') }}" id="searchForm">
                            ...
                            <li>
                                <div class="view-icons">
                                    <a href="{{ url('doctor/doctor-appointments-grid') }}" class="active"><i
                                                    ...
                                                    <div class="appointment-grid-head">
                                                        <div class="patinet-information">
                                                            <a href="{{ url('doctor-upcoming-appointment') }}">
                                                                <img src="{{ $appointment->user->profile_image ?? URL::asset('/assets/img/doctors-dashboard/profile-01.jpg') }}"
                                                                    alt="User Image">
                                                            </a>
                                                            <div class="patient-info">
                                                                <p>#{{ $appointment->id ?? '' }}</p>
                                                                <h6><a
                                                                        href="{{ url('doctor-upcoming-appointment') }}">{{ $appointment->user->name ?? '' }}</a>
                                                                </h6>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="appointment-grid-head">
                                                    <div class="patinet-information">
                                                        <a href="{{ url('doctor-cancelled-appointment') }}">
                                                            <img src="{{$rejected->user->profile_image ?? URL::asset('/assets/img/doctors-dashboard/profile-01.jpg') }}"
                                                                alt="User Image">
                                                        </a>
                                                        <div class="patient-info">
                                                            <p>#Apt0001</p>
                                                            <h6><a
                                                                    href="{{ url('doctor-cancelled-appointment') }}">{{ $rejected->name ?? '' }}</a>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                    <div class="grid-user-msg">
                                                ...
                                                <div class="appointment-grid-head">
                                                    <div class="patinet-information">
                                                        <a href="{{ url('doctor-completed-appointment') }}">
                                                            <img src="{{$completed->user->profile_umage ?? URL::asset('/assets/img/doctors-dashboard/profile-01.jpg') }}"
                                                                alt="User Image">
                                                        </a>
                                                        <div class="patient-info">
                                                            <p>#{{ $completed->id ?? '' }}</p>
                                                            <h6><a
                                                                    href="{{ url('doctor-completed-appointment') }}">{{ $completed->user->name ?? '' }}</a>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                    <div class="grid-user-msg">
