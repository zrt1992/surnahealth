                        ...
                        <div class="inner-right-login">
                            <div class="login-header">
                                ...
                                <form id="personal_details" enctype="multipart/form-data">  
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-5 ps-2">
                                                    <select class="form-select form-control select" id="weight_unit" name="weight_unit" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="mt-5">
                                        <a href="{{url('doctor-register-step3')}}" class="btn btn-primary w-100 btn-lg login-btn step2_submit">Continue </a>
                                    </div>
                                </form>
                            </div>
                        </div>
