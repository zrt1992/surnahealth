<?php $page = 'doctor-help-and-support'; ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-xl-9">
                    ...
                    <form action="{{ route('doctor-create-ticket') }}" method="POST">
                        @csrf
                            ...
                            <div class="custom-table mt-3">
                                <div class="table-responsive">
                                    <table class="table table-center mb-0">
                                        ...
                                        <tbody>
                                            @if (!empty($doctorTicket) && $doctorTicket->isNotEmpty())
                                                @foreach ($doctorTicket as $ticket)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="action-item">
                                                                <a href="javascript:void(0)" data-bs-toggle="modal"
                                                                    ...
                                                                    data-id="{{ $ticket->id }}"
                                                                    data-route="{{ route('doctor-ticket-remove', ':id') }}">
