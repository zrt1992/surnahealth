...
@section('content')
    <style>
        .banner {
            background-image: url('/assets/img/prostate-cancer-banner.webp');
    ...
    <section class="banner text-center d-flex align-items-center justify-content-center"
        ...
        <div class="container">
            <h1 class="mb-3" style="font-size: 3rem; font-weight: bold;">
                Catch prostate cancer <br> <span style="font-size: 5rem; color: #39e664;">sooner</span>.
            </h1>
            <div class="d-flex flex-column align-items-center justify-content-center">
                <div class="text-start" style="max-width: 60%; text-align: left;">
                    ...
                    <p class="text-black" style="font-size: 2rem; font-weight: bold;">
                        Virtual support <span style="font-size: 1rem; font-weight: normal;">from a prostate
                            specialist.</span>
                    </p>
                </div>
            </div>
                ...
                <form method="POST" id="payment-form-2">
                    ...
                    <div class="col-12 d-flex col-xxl-12 col-lg-12 col-sm-6">
                        ...
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <button type="button" id="assesment-checkout-button-2" class="btn btn-primary submit-btn">Learn
                                your
                                risk</button>
