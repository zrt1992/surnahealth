                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-md-6 col-auto">
                            <div class="view-icons ">
                                <a href="{{ url('map-grid') }}" class="grid-view active"><i class="fas fa-th-large"></i></a>
                                <a href="{{ url('map-list') }}" class="list-view"><i class="fas fa-bars"></i></a>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-6">
                            <div class="profile-widget">
                                ...
                                <div class="pro-content">
                                    <h3 class="title">
                                        <a href="{{ url('doctor-profile') }}">Dr. Marvin Campbell</a>
                                        <i class="fas fa-check-circle verified"></i>
                                    </h3>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-6">
                            <div class="profile-widget">
                                ...
                                <div class="pro-content">
                                    <h3 class="title">
                                        <a href="{{ url('doctor-profile') }}">Dr. Katharine Berthold</a>
                                        <i class="fas fa-check-circle verified"></i>
                                    </h3>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-6">
                            <div class="profile-widget">
                                ...
                                <div class="pro-content">
                                    <h3 class="title">
                                        <a href="{{ url('doctor-profile') }}">Dr. Linda Tobin</a>
                                        <i class="fas fa-check-circle verified"></i>
                                    </h3>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-6">
                            <div class="profile-widget">
                                <div class="doc-img">
                                    <a href="{{ url('doctor-profile') }}">
                                        <img class="img-fluid" alt="User Image"
                                            src="{{ URL::asset('/assets/img/doctors/doctor-11.jpg') }}">
                                    </a>
                                    <a href="javascript:void(0)" class="fav-btn">
                                        <i class="far fa-bookmark"></i>
                                    </a>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-6">
                            <div class="profile-widget">
                                <div class="doc-img">
                                    <a href="{{ url('doctor-profile') }}">
                                        <img class="img-fluid" alt="User Image"
                                            src="{{ URL::asset('/assets/img/doctors/doctor-12.jpg') }}">
                                    </a>
                                    <a href="javascript:void(0)" class="fav-btn">
                                        <i class="far fa-bookmark"></i>
                                    </a>
