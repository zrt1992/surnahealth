                                ...
                                <div class="custom-table">
                                    <div class="table-responsive">
                                        <table class="table table-center mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><a class="text-blue-600" href="{{url('patient-upcoming-appointment')}}">#Apt123</a></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><a class="text-blue-600" href="{{url('patient-upcoming-appointment')}}">#Apt124</a></td>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="{{url('doctor-profile')}}" class="avatar avatar-sm me-2">
                                                ...
                                                <tr>
                                                    <td><a class="text-blue-600" href="{{url('patient-upcoming-appointment')}}">#Apt125</a></td>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="{{url('doctor-profile')}}" class="avatar avatar-sm me-2">
                                                ...
                                                <tr>
                                                    <td><a class="text-blue-600" href="{{url('patient-upcoming-appointment')}}">#Apt126</a></td>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="{{url('doctor-profile')}}" class="avatar avatar-sm me-2">
                                                ...
                                                <tr>
                                                    <td><a class="text-blue-600" href="{{url('patient-upcoming-appointment')}}">#Apt127</a></td>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="{{url('doctor-profile')}}" class="avatar avatar-sm me-2">
                                                ...
                                                <tr>
                                                    <td><a class="text-blue-600" href="{{url('patient-cancelled-appointment')}}">#Apt128</a></td>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="{{url('doctor-profile')}}" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{URL::asset('/assets/img/doctors/doctor-thumb-09.jpg')}}" alt="User Image">
                                                            </a>
                                                ...
                                                <tr>
                                                    <td><a class="text-blue-600" href="{{url('patient-completed-appointment')}}">#Apt129</a></td>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="{{url('doctor-profile')}}" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{URL::asset('/assets/img/doctors/doctor-thumb-07.jpg')}}" alt="User Image">
                                                            </a>
