            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-sm-5 col">
                        <a href="{{ url('pharmacy-admin/add-purchase') }}" class="btn btn-primary float-end mt-2">Add
                            New</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="datatable table table-hover table-center mb-0" id="purchase_data">
                                    <thead>
                                        <tr>
                                            <th>Purchase Date</th>
                                            <th>Medicine Name</th>
