                    ...
                    <div class="doctor-widget">
                        <div class="doc-info-left">
                            ...
                            <div class="doc-info-cont">
                                <h4 class="doc-name mb-2"><a href="{{ url('pharmacy-details') }}">Medlife Medical</a></h4>
                                ...
                                <div class="clinic-details">
                                    <div class="clini-infos pt-3">
                                        ...
                                        <p class="doc-location mb-2"><i class="fas fa-phone-volume me-1"></i> 320-795-8815
                                        </p>
                                        <p class="doc-location mb-2 text-ellipse"><i class="fas fa-map-marker-alt me-1"></i>
                                            96 Red Hawk Road Cyrus, MN 56323 </p>
                                        <p class="doc-location mb-2"><i class="fas fa-chevron-right me-1"></i> Chemists,
                                            Surgical Equipment Dealer</p>

                                        <p class="doc-location mb-2"><i class="fas fa-chevron-right me-1"></i> Opens at
                                            08.00 AM</p>
                        ...
                        <div class="doc-info-right d-flex align-items-center justify-content-center">
                            <div class="clinic-booking">
                                <a class="view-pro-btn" href="{{ url('chat') }}">Send Message</a>
                                <a class="apt-btn" href="javascript:;" data-bs-toggle="modal" data-bs-target="#voice_call">Call
                                    Now</a>
                                <a href="{{ url('product-all') }}" class="view-pro-btn">Browse Products</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="clinic-content">
                                            ...
                                            <div class="clinic-details mb-0">
                                                <h5 class="clinic-direction"> <i class="fas fa-map-marker-alt"></i> 96 Red
                                                    Hawk Road Cyrus, MN 56323 <br><a href="javascript:void(0);">Get
                                                        Directions</a></h5>
                                                        <ul>
															<li>
																<a href="{{ URL::asset('assets/img/features/feature-01.jpg')}}" data-fancybox="gallery2">
																	<img src="{{ URL::asset('assets/img/features/feature-01.jpg')}}" alt="Feature Image">
																</a>
															</li>
															<li>
																<a href="{{ URL::asset('assets/img/features/feature-02.jpg')}}" data-fancybox="gallery2">
																	<img src="{{ URL::asset('assets/img/features/feature-02.jpg')}}" alt="Feature Image">
																</a>
															</li>
															<li>
																<a href="{{ URL::asset('assets/img/features/feature-03.jpg')}}" data-fancybox="gallery2">
																	<img src="{{ URL::asset('assets/img/features/feature-03.jpg')}}" alt="Feature Image">
																</a>
															</li>
															<li>
																<a href="{{ URL::asset('assets/img/features/feature-04.jpg')}}" data-fancybox="gallery2">
